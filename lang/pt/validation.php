...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduções em português das mensagens de validação predefinidas do
    | Laravel. Algumas regras, como "size", possuem variantes consoante o
    | tipo de dados validado (numérico, ficheiro, string ou array).
    |
    */
    ...
    'current_password' => 'A senha introduzida está incorreta.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute indicado consta numa fuga de dados conhecida. Escolha um :attribute diferente.',
    ],
    ...
    */
    ...
    'custom' => [
        'terms' => [
            'accepted' => 'É necessário aceitar os Termos de Utilização e a Política de Privacidade para criar a conta.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'data' => 'data',
        'periodo_id' => 'período',
        'secretaria_id' => 'secretária',
        'observacoes' => 'observações',
        'assunto' => 'assunto',
        'mensagem' => 'mensagem',
        'planta_x' => 'posição horizontal',
        'planta_y' => 'posição vertical',
        'estado' => 'estado',
        'setor' => 'setor',
    ],
