...
export default function Create() {
    ...
    const submit = (event) => {
        ...
        post(route('admin.edificios.store'), { forceFormData: true });
    };

    return (
        <DashboardLayout>
            <Head title={t('edificios.create.titulo')} />
            ...
            <section className="dashboard-card overflow-hidden">
                <div className="flex items-center gap-3 border-b border-slate-100 px-6 py-5 dark:border-slate-800">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-slate-900 dark:text-white">
                            {t('edificios.create.titulo')}
                        </h1>

                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            {t('edificios.create.subtitulo')}
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="p-6" noValidate>
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <label htmlFor="imagem" className="flex h-11 w-full cursor-pointer items-center gap-2 rounded-xl border border-dashed border-slate-300 px-3 text-sm text-slate-500 transition hover:border-teal-500 hover:text-teal-500 dark:border-slate-700">
                                ...
                                {data.imagem ? data.imagem.name : t('campos.escolherFicheiro')}
                            </label>
                    ...
                    <div className="mt-8 flex items-center gap-3">
                        ...
                        >
                            {processing ? t('edificios.create.aCriar') : t('edificios.create.criar')}
                        </button>
