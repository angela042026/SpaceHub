                ...
                <div className="flex items-center gap-3 border-b border-slate-100 px-6 py-5 dark:border-slate-800">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            Cadastra um novo piso associado a um edifício.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                {data.planta ? data.planta.name : 'Escolher ficheiro'}
                            </label>
                        ...
                        {preview && (
                            <div className="sm:col-span-2">
                                <img src={preview} alt="Pré-visualização da planta" className="max-h-48 rounded-xl border border-slate-200 object-contain dark:border-slate-700" />
                            </div>
                        )}
