                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={pesquisar} className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-5" >
                                <div>
                                    ...
                                    {reservas.length === 0 ? (
                                        ...
                                        reservas.map((reserva) => (
                                            <tr key={reserva.id}>
                                                ...
                                                <td className="px-4 py-3">
                                                {/* muda cor conforme estado da reserva */}
                                                    <span
                                                        className={`rounded px-2 py-1 text-sm ${reserva.estado_reserva.codigo === 'pendente'
